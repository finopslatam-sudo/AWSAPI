...
Estados:
- pending_approval   : suscripción creada en PayPal, esperando aprobación del usuario
- pending_activation : PayPal confirmó el pago, esperando que admin active la cuenta
